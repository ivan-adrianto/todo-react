...
import { updateAction, deleteAction, addAction } from '../redux/actions/Actions';
        ...
        <div>
            ...
            <Modal isOpen={trigger} toggle={toggle} className='modal-todo'>
                ...
                <ModalBody className='modal-description'>
                    <label>Title: </label>
                    <input placeholder='Enter the title of the task' className='form-control' onChange={e => setTitle(e.target.value)} /> <br />
                    <label>Description: </label>
                    <input placeholder='Enter the description of the task' className='form-control' onChange={e => setDescription(e.target.value)} /> <br />
                </ModalBody>
                <ModalFooter>
